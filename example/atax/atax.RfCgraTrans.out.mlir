filename = atax.RfCgraTransFinal.cloog 
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %4 = memref.cast %0 : memref<1800x2200xf64> to memref<?x2200xf64>
    %5 = memref.cast %1 : memref<2200xf64> to memref<?xf64>
    call @init_array(%c1800_i32, %c2200_i32, %4, %5) : (i32, i32, memref<?x2200xf64>, memref<?xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    %6 = memref.cast %2 : memref<2200xf64> to memref<?xf64>
    %7 = memref.cast %3 : memref<1800xf64> to memref<?xf64>
    call @kernel_atax_opt(%c1800_i32, %c2200_i32, %4, %5, %6, %7) : (i32, i32, memref<?x2200xf64>, memref<?xf64>, memref<?xf64>, memref<?xf64>) -> ()
    ...
    scf.if %9 {
      call @print_array(%c2200_i32, %6) : (i32, memref<?xf64>) -> ()
    }
  ...
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?x2200xf64>, %arg3: memref<?xf64>) {
    ...
    %2 = scf.for %arg4 = %c0 to %1 step %c1 iter_args(%arg5 = %c0_i32) -> (i32) {
      %4 = index_cast %arg5 : i32 to index
      %5 = sitofp %c1_i32 : i32 to f64
      %6 = sitofp %arg5 : i32 to f64
      %7 = divf %6, %0 : f64
      %8 = addf %5, %7 : f64
      memref.store %8, %arg3[%4] : memref<?xf64>
  ...
  func private @kernel_atax(%arg0: i32, %arg1: i32, %arg2: memref<?x2200xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>) {
    %0 = index_cast %arg1 : i32 to index
    affine.for %arg6 = 0 to %0 {
      call @S0(%arg4, %arg6) : (memref<?xf64>, index) -> ()
    }
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg6 = 0 to %1 {
      call @S1(%arg5, %arg6) : (memref<?xf64>, index) -> ()
      affine.for %arg7 = 0 to %0 {
        call @S2(%arg5, %arg6, %arg3, %arg7, %arg2) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2200xf64>) -> ()
      }
      affine.for %arg7 = 0 to %0 {
        call @S3(%arg4, %arg7, %arg5, %arg6, %arg2) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2200xf64>) -> ()
      }
    }
    return
  }
  ...
  func private @kernel_atax_opt(%arg0: i32, %arg1: i32, %arg2: memref<?x2200xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.if #set()[%1, %0] {
      affine.for %arg6 = 0 to min #map()[%1, %0] {
        call @S0(%arg4, %arg6) : (memref<?xf64>, index) -> ()
        call @S1(%arg5, %arg6) : (memref<?xf64>, index) -> ()
      }
      affine.for %arg6 = %0 to %1 {
      ...
      affine.for %arg6 = 0 to %1 {
        affine.for %arg7 = 0 to %0 {
          call @S2(%arg5, %arg7, %arg3, %arg6, %arg2) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2200xf64>) -> ()
        }
      }
      affine.for %arg6 = 0 to %0 {
