// RUN: RfCgraTrans-opt %s -demote-loop-reduction -reg2mem -split-input-file | FileCheck %s
...
// CHECK-NEXT:     %[[VAL10:.*]] = mulf %[[VAL6]], %[[VAL8]] : f32
...
// CHECK-NEXT:   %[[VAL5:.*]] = addf %[[VAL4]], %[[VAL3]] : f32
