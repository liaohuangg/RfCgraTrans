...
输出minP
 ...
 start Scc 0 end Scc 0 inner iter 2 Cost 16661700

 start Scc 0 end Scc 1 inner iter 2 Cost 27158679
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_heat_3d_opt(%c1000_i32, %c200_i32, %2, %3) : (i32, i32, memref<?x200x200xf64>, memref<?x200x200xf64>) -> ()
    ...
    affine.for %arg4 = 1 to #map()[%0] {
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          call @S0(%arg3, %arg4, %arg5, %arg6, %arg2) : (memref<?x200x200xf64>, index, index, index, memref<?x200x200xf64>) -> ()
        }
      }
    }
    affine.for %arg4 = 1 to #map()[%0] {
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          call @S1(%arg2, %arg4, %arg5, %arg6, %arg3) : (memref<?x200x200xf64>, index, index, index, memref<?x200x200xf64>) -> ()
        }
      }
    }
    return
  ...
  func private @S0(%arg0: memref<?x200x200xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<?x200x200xf64>) attributes {scop.stmt} {
    %cst = constant 2.000000e+00 : f64
    %cst_0 = constant 1.250000e-01 : f64
    %0 = affine.load %arg4[symbol(%arg1) + 1, symbol(%arg2), symbol(%arg3)] : memref<?x200x200xf64>
    %1 = affine.load %arg4[symbol(%arg1) - 1, symbol(%arg2), symbol(%arg3)] : memref<?x200x200xf64>
    %2 = affine.load %arg4[symbol(%arg1), symbol(%arg2) + 1, symbol(%arg3)] : memref<?x200x200xf64>
    %3 = affine.load %arg4[symbol(%arg1), symbol(%arg2) - 1, symbol(%arg3)] : memref<?x200x200xf64>
    %4 = affine.load %arg4[symbol(%arg1), symbol(%arg2), symbol(%arg3) + 1] : memref<?x200x200xf64>
    %5 = affine.load %arg4[symbol(%arg1), symbol(%arg2), symbol(%arg3) - 1] : memref<?x200x200xf64>
    %6 = affine.load %arg4[symbol(%arg1), symbol(%arg2), symbol(%arg3)] : memref<?x200x200xf64>
    %7 = mulf %cst, %6 : f64
    %8 = subf %0, %7 : f64
    %9 = addf %8, %1 : f64
    %10 = mulf %cst_0, %9 : f64
    ...
    %18 = addf %14, %17 : f64
    %19 = addf %18, %6 : f64
    affine.store %19, %arg0[symbol(%arg1), symbol(%arg2), symbol(%arg3)] : memref<?x200x200xf64>
    return
  }
  func private @S1(%arg0: memref<?x200x200xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<?x200x200xf64>) attributes {scop.stmt} {
    %cst = constant 2.000000e+00 : f64
    %cst_0 = constant 1.250000e-01 : f64
    %0 = affine.load %arg4[symbol(%arg1) + 1, symbol(%arg2), symbol(%arg3)] : memref<?x200x200xf64>
    %1 = affine.load %arg4[symbol(%arg1) - 1, symbol(%arg2), symbol(%arg3)] : memref<?x200x200xf64>
  ...
  func private @kernel_heat_3d_opt(%arg0: i32, %arg1: i32, %arg2: memref<?x200x200xf64>, %arg3: memref<?x200x200xf64>) {
    %0 = index_cast %arg1 : i32 to index
    affine.if #set()[%0] {
      affine.for %arg4 = 1 to #map()[%0] {
        affine.for %arg5 = 1 to #map()[%0] {
...
One 0 spand time: 0.014833 
One 1 spand time: 0.013139 
One 2 spand time: 0.011213 
One 3 spand time: 0.040485 
One 4 spand time: 0.038692 
One 5 spand time: 0.037791 
One 6 spand time: 0.013997 
One 7 spand time: 0.012042 
One 8 spand time: 0.011479 
Once spand time: 0.018508 
our total spand time: 0.329974 
