...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_jacobi_1d_opt(%c1000_i32, %c4000_i32, %2, %3) : (i32, i32, memref<?xf64>, memref<?xf64>) -> ()
  ...
  func private @kernel_jacobi_1d(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>) {
    ...
    affine.for %arg4 = 1 to #map0()[%0] {
      call @S0(%arg3, %arg4, %arg2) : (memref<?xf64>, index, memref<?xf64>) -> ()
    }
    affine.for %arg4 = 1 to #map0()[%0] {
      call @S1(%arg2, %arg4, %arg3) : (memref<?xf64>, index, memref<?xf64>) -> ()
    }
    return
  }
  ...
  func private @S0(%arg0: memref<?xf64>, %arg1: index, %arg2: memref<?xf64>) attributes {scop.stmt} {
    ...
    %0 = affine.load %arg2[symbol(%arg1) - 1] : memref<?xf64>
    %1 = affine.load %arg2[symbol(%arg1)] : memref<?xf64>
    %2 = addf %0, %1 : f64
    %3 = affine.load %arg2[symbol(%arg1) + 1] : memref<?xf64>
    %4 = addf %2, %3 : f64
    %5 = mulf %cst, %4 : f64
  ...
  func private @kernel_jacobi_1d_opt(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>) {
    %c1 = constant 1 : index
    %0 = index_cast %arg1 : i32 to index
    affine.if #set()[%0] {
      call @S0(%arg3, %c1, %arg2) : (memref<?xf64>, index, memref<?xf64>) -> ()
      affine.for %arg4 = 2 to #map0()[%0] {
        call @S0(%arg3, %arg4, %arg2) : (memref<?xf64>, index, memref<?xf64>) -> ()
        %2 = affine.apply #map1(%arg4)
        call @S1(%arg2, %2, %arg3) : (memref<?xf64>, index, memref<?xf64>) -> ()
      }
      %1 = affine.apply #map2()[%0]
      call @S1(%arg2, %1, %arg3) : (memref<?xf64>, index, memref<?xf64>) -> ()
    }
    return
  }
