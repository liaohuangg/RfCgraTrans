filename = 2mm.RfCgraTransFinal.cloog 
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_2mm_opt(%c1600_i32, %c1800_i32, %c2200_i32, %c2400_i32, %13, %14, %15, %9, %10, %11, %12) : (i32, i32, i32, i32, f64, f64, memref<?x1800xf64>, memref<?x2200xf64>, memref<?x1800xf64>, memref<?x2400xf64>, memref<?x2400xf64>) -> ()
  ...
  func private @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<?x1800xf64>, %arg7: memref<?x2200xf64>, %arg8: memref<?x1800xf64>, %arg9: memref<?x2400xf64>, %arg10: memref<?x2400xf64>) {
    ...
    affine.for %arg11 = 0 to %3 {
      affine.for %arg12 = 0 to %0 {
        call @S0(%arg6, %arg11, %arg12) : (memref<?x1800xf64>, index, index) -> ()
        affine.for %arg13 = 0 to %1 {
          call @S1(%arg6, %arg11, %arg12, %arg8, %arg13, %arg4, %arg7) : (memref<?x1800xf64>, index, index, memref<?x1800xf64>, index, f64, memref<?x2200xf64>) -> ()
        }
      }
    }
    affine.for %arg11 = 0 to %3 {
      affine.for %arg12 = 0 to %2 {
        call @S2(%arg10, %arg11, %arg12, %arg5) : (memref<?x2400xf64>, index, index, f64) -> ()
        affine.for %arg13 = 0 to %0 {
          call @S3(%arg10, %arg11, %arg12, %arg9, %arg13, %arg6) : (memref<?x2400xf64>, index, index, memref<?x2400xf64>, index, memref<?x1800xf64>) -> ()
        }
      }
    }
    return
  ...
  func private @kernel_2mm_opt(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<?x1800xf64>, %arg7: memref<?x2200xf64>, %arg8: memref<?x1800xf64>, %arg9: memref<?x2400xf64>, %arg10: memref<?x2400xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    %2 = index_cast %arg2 : i32 to index
    %3 = index_cast %arg3 : i32 to index
    affine.if #set()[%0, %1, %2, %3] {
      affine.for %arg11 = 0 to min #map()[%1, %3] {
        affine.for %arg12 = 0 to %0 {
          call @S0(%arg6, %arg12, %arg11) : (memref<?x1800xf64>, index, index) -> ()
          call @S2(%arg10, %arg12, %arg11, %arg5) : (memref<?x2400xf64>, index, index, f64) -> ()
        }
      }
      affine.for %arg11 = %3 to %1 {
        affine.for %arg12 = 0 to %0 {
          call @S0(%arg6, %arg12, %arg11) : (memref<?x1800xf64>, index, index) -> ()
        }
      }
      affine.for %arg11 = %1 to %3 {
        affine.for %arg12 = 0 to %0 {
          call @S2(%arg10, %arg12, %arg11, %arg5) : (memref<?x2400xf64>, index, index, f64) -> ()
        }
      }
      affine.for %arg11 = 0 to %0 {
        affine.for %arg12 = 0 to %2 {
          affine.for %arg13 = 0 to %1 {
            call @S1(%arg6, %arg11, %arg13, %arg8, %arg12, %arg4, %arg7) : (memref<?x1800xf64>, index, index, memref<?x1800xf64>, index, f64, memref<?x2200xf64>) -> ()
          }
        }
      }
      affine.for %arg11 = 0 to %0 {
        affine.for %arg12 = 0 to %1 {
          affine.for %arg13 = 0 to %3 {
            call @S3(%arg10, %arg11, %arg13, %arg9, %arg12, %arg6) : (memref<?x2400xf64>, index, index, memref<?x2400xf64>, index, memref<?x1800xf64>) -> ()
          }
        }
      }
    }
