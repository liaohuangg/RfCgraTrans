filename = gesummv.RfCgraTransFinal.cloog 
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_gesummv_opt(%c2800_i32, %12, %13, %9, %10, %14, %11, %15) : (i32, f64, f64, memref<?x2800xf64>, memref<?x2800xf64>, memref<?xf64>, memref<?xf64>, memref<?xf64>) -> ()
  ...
  func private @kernel_gesummv(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<?x2800xf64>, %arg4: memref<?x2800xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>) {
    ...
    affine.for %arg8 = 0 to %0 {
      ...
      call @S1(%arg7, %arg8, %arg5) : (memref<?xf64>, index, memref<?xf64>) -> ()
      affine.for %arg9 = 0 to %0 {
        call @S2(%arg5, %arg8, %arg6, %arg9, %arg3) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2800xf64>) -> ()
        call @S3(%arg7, %arg8, %arg6, %arg9, %arg4) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2800xf64>) -> ()
      }
      call @S4(%arg7, %arg8, %arg2, %arg1, %arg5) : (memref<?xf64>, index, f64, f64, memref<?xf64>) -> ()
    }
    return
  }
  ...
  func private @S1(%arg0: memref<?xf64>, %arg1: index, %arg2: memref<?xf64>) attributes {scop.stmt} {
  ...
  func private @kernel_gesummv_opt(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<?x2800xf64>, %arg4: memref<?x2800xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.if #set()[%0] {
      affine.for %arg8 = 0 to %0 {
        call @S0(%arg5, %arg8) : (memref<?xf64>, index) -> ()
      ...
      affine.for %arg8 = 0 to %0 {
        affine.for %arg9 = 0 to %0 {
          call @S2(%arg5, %arg9, %arg6, %arg8, %arg3) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2800xf64>) -> ()
          call @S3(%arg7, %arg9, %arg6, %arg8, %arg4) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2800xf64>) -> ()
        }
      }
      affine.for %arg8 = 0 to %0 {
        call @S4(%arg7, %arg8, %arg2, %arg1, %arg5) : (memref<?xf64>, index, f64, f64, memref<?xf64>) -> ()
