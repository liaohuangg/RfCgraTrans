module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_bicg(%c1800_i32, %c2200_i32, %5, %8, %9, %7, %6) : (i32, i32, memref<?x1800xf64>, memref<?xf64>, memref<?xf64>, memref<?xf64>, memref<?xf64>) -> ()
  ...
  func private @kernel_bicg(%arg0: i32, %arg1: i32, %arg2: memref<?x1800xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        ...
        %4 = affine.load %arg2[%arg7, %arg8] : memref<?x1800xf64>
        %5 = mulf %3, %4 : f64
        %6 = addf %2, %5 : f64
        ...
        %9 = mulf %4, %8 : f64
        %10 = addf %7, %9 : f64
        affine.store %10, %arg4[%arg7] : memref<?xf64>
      }
    }
    return
  }
