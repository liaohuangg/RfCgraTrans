filename = 3mm.RfCgraTransFinal.cloog 
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_3mm_opt(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<?x1800xf64>, %arg6: memref<?x2000xf64>, %arg7: memref<?x1800xf64>, %arg8: memref<?x2200xf64>, %arg9: memref<?x2400xf64>, %arg10: memref<?x2200xf64>, %arg11: memref<?x2200xf64>) {
    ...
    affine.if #set()[%0, %1, %2, %3, %4] {
      affine.for %arg12 = 0 to min #map()[%0, %1] {
        affine.for %arg13 = 0 to min #map()[%1, %3] {
          call @S0(%arg5, %arg12, %arg13) : (memref<?x1800xf64>, index, index) -> ()
          call @S2(%arg8, %arg12, %arg13) : (memref<?x2200xf64>, index, index) -> ()
          call @S4(%arg11, %arg12, %arg13) : (memref<?x2200xf64>, index, index) -> ()
        }
        affine.for %arg13 = %3 to %1 {
          call @S0(%arg5, %arg12, %arg13) : (memref<?x1800xf64>, index, index) -> ()
        }
        affine.for %arg13 = %1 to %3 {
          call @S2(%arg8, %arg12, %arg13) : (memref<?x2200xf64>, index, index) -> ()
          call @S4(%arg11, %arg12, %arg13) : (memref<?x2200xf64>, index, index) -> ()
        }
      }
      ...
      affine.for %arg12 = 0 to %1 {
        affine.for %arg13 = 0 to %4 {
          affine.for %arg14 = 0 to %3 {
            call @S3(%arg8, %arg12, %arg14, %arg10, %arg13, %arg9) : (memref<?x2200xf64>, index, index, memref<?x2200xf64>, index, memref<?x2400xf64>) -> ()
          }
        }
      }
      affine.for %arg12 = 0 to %0 {
        affine.for %arg13 = 0 to %2 {
          affine.for %arg14 = 0 to %1 {
            call @S1(%arg5, %arg12, %arg14, %arg7, %arg13, %arg6) : (memref<?x1800xf64>, index, index, memref<?x1800xf64>, index, memref<?x2000xf64>) -> ()
          }
        }
      }
      affine.for %arg12 = 0 to %0 {
        affine.for %arg13 = 0 to %1 {
          affine.for %arg14 = 0 to %3 {
            call @S5(%arg11, %arg12, %arg14, %arg8, %arg13, %arg5) : (memref<?x2200xf64>, index, index, memref<?x2200xf64>, index, memref<?x1800xf64>) -> ()
          }
        }
      }
    }
